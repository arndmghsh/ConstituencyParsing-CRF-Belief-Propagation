...
train_sentences = encoded_sentences[0:34446]
test_sentences = encoded_sentences[34446:49208]
train_trees = my_trees[0:34446]
test_trees = my_trees[34446:49208]
...
for epoch in range(EPOCHS):
    ...
    for i, sent in enumerate(train_sentences):
        ...
        if i%1000 == 0: print("Train Sentence: {}".format(i))
    ...
    for i, sent in enumerate(test_sentences):
        ...
        if i%1000 == 0: print("Test Sentence: {}".format(i))
