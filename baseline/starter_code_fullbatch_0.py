...
train_lacc = []
# test_celoss = []
num_train = len(encoded_sentences)
for epoch in range(EPOCHS):
    ...
    print("Epoch: {} Train Loss: {:.2f}, Test Loss: {:.2f}, Train Acc: {:.2f} Train L-ACC: {:.2f}".format(
                    epoch, epoch_loss, epoch_loss, epoch_acc, epoch_lacc))
    print(train_celoss)
    print(train_acc)
    print(train_lacc)
#     # # Testing Loss
